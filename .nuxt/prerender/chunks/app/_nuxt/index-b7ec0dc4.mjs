import { ref, mergeProps, unref, useSSRContext, withCtx, createVNode, createTextVNode, withDirectives, vModelText, openBlock, createBlock, createCommentVNode } from 'file:///data/data/com.termux/files/home/onelink/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrInterpolate, ssrRenderSlot } from 'file:///data/data/com.termux/files/home/onelink/node_modules/vue/server-renderer/index.mjs';
import { b as _export_sfc } from '../server.mjs';
import __nuxt_component_4 from './Icon-852aaaf9.mjs';
import draggable from 'file:///data/data/com.termux/files/home/onelink/node_modules/vuedraggable/dist/vuedraggable.umd.min.js';
                  ...
                  createVNode("div", null, [
                    ...
                    createVNode("div", { class: "mt-1" }, [
                      createVNode("textarea", {
                        ...
                        placeholder: "Soy un joven apasionado por la programaci\xF3n",
                        maxlength: "100",
                        value: __props.desc,
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_base_form_section, mergeProps({
        title: "Social Links",
        description: "Agrega enlaces directos a tus redes sociales y personalizalas"
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                  ...
                  createVNode("div", null, [
                    ...
                    createVNode("div", { class: "mt-1 flex rounded-md shadow-sm" }, [
                      ...
                      createVNode("input", {
                        ...
                        placeholder: "https://fb.com/drowkid1"
                      }, null, 40, ["value", "onInput"])
                    ])
                  ]),
                  createVNode("div", null, [
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="border-t bg-white flex items-center"><button class="h-12 flex items-center space-x-2 px-4 border-r text-xs font-medium bg-white text-slate-700"><span> Agrega datos aleatorios</span>`);
      _push(ssrRenderComponent(_component_icon, {
        name: "mdi:code-json",
        class: "h-4 w-4"
      }, null, _parent));
      _push(`</button><button class="h-12 flex items-center space-x-2 px-4 border-r text-xs font-medium bg-white text-slate-700"><span> Publicar </span>`);
      _push(ssrRenderComponent(_component_icon, {
        name: "ph:paper-plane-tilt-bold",
        class: "h-4 w-4"
      }, null, _parent));
      _push(`</button><a href="https://github.com/drowkid-1/drowlinks-generador" target="_blank" class="h-12 flex items-center space-x-2 px-4 border-r text-xs font-medium bg-white text-slate-700"><span> Github </span>`);
      _push(ssrRenderComponent(_component_icon, {
        name: "mdi:github",
        class: "h-4 w-4"
      }, null, _parent));
      ...
      _push(`<a href="https://twitter.com" target="_blank" class="absolute bottom-0 right-0 bg-white rounded-tl-lg shadow px-4 py-1 font-medium text-sm text-gray-500"> Made by DrowKid </a></div>`);
    };
  }
};
...
//# sourceMappingURL=index-b7ec0dc4.mjs.map

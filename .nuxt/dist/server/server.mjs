import { getCurrentInstance, reactive, toRef, isRef, inject, version, defineComponent, computed, ref, h, resolveComponent, defineAsyncComponent, nextTick, shallowRef, isReadonly, unref, Transition, Suspense, provide, useSSRContext, withCtx, createVNode, onErrorCaptured, onServerPrefetch, createApp } from "vue";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/1-61b6de46.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index-b7ec0dc4.js").then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component-d87d7dff.js").then((r) => r.default || r));
